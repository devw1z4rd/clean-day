<template>
  <UCard :ui="{ ring: '', header: { padding: 'px-6 py-4' }, body: { base: 'p-6' } }"
    class="mt-6 mb-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-md">
    <template #header>
  ...
  <UCard v-if="!syncStore.isSessionActive && syncStore.configValid"
    :ui="{ ring: '', header: { padding: 'px-6 py-4' }, body: { base: 'p-6' } }"
